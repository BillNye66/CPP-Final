...
int main(int argc, char *argv[]) {
	...
	while (dataType == "short" || dataType == "int" || dataType == "integer" || dataType == "float" || dataType == "double" || dataType == "boolean" || dataType == "bool" || dataType == "string" ) {
		if (dataType == "short") {
			...
			cout << "Current instruction: for (i = 0; i < 5; i++) {" << endl;
			cout << "	cout << array[i] << endl;" << endl;
			cout << "}" << endl;
			for (int i = 0; i < 5; i++) {
				cout << array[i] << endl;
			}
			...
			int input = 0;
			cout << "Enter integer values for the array (you will be prompted to enter five):" <<endl;
			for (int i = 0; i < 5; i++) {
			...
			float input = 0.9999;
			cout << "Enter float values for the array (you will be prompted to enter five):" << endl;
			for (int i = 0; i < 5; i++) {
			...
			double input = 0.0;
			cout << "Enter double values for the array (you will be prompted to enter five):" << endl;
			for (int i = 0; i < 5; i++) {
			...
			bool input = false;
			cout << "Enter boolean values for the array (you will be prompted to enter five):" << endl;
			for (int i = 0; i < 5; i++) {
			...
			string array[5] = {"", "", "", "", ""};
			string input = "";
			cout << "Enter string values for the array (you will be prompted to enter five):" << endl;
			for (int i = 0; i < 5; i++) {
				cin >> input;
				array[i] = input;
			}
			...
			cout << "Input does not match a C++ datatype. Available data types are \"short\" \"integer\" \"float\" \"double\" \"boolean\" and \"string\"" << endl;
		}
	}
}
